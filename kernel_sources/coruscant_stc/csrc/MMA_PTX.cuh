...
__device__ __forceinline__ void Coruscant_STC_FragLoadFromSharedToRegisters(uint32_t __restrict__ Registers[][4],
...
__device__ __forceinline__ void Coruscant_STC_B_FragLoadFromSharedToRegisters(uint32_t __restrict__ Registers[][4],
                                                                half* __restrict__ smem,
                                                                int warp_start_row,
                                                                int k_offset)
{
    ...
    int j = (lane_id % 16) >= 8 ? 1 : 0;
        //For lane_id values 0-7 and 16-23, j = 0.
        //For lane_id values 8-15 and 24-31, j = 1.
